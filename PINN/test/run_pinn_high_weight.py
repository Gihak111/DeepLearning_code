...
# Stage 2: PINN with very high BC weight
print("\n=== Stage 2: PINN training with BC weight = 10000.0 (3000 epochs) ===")
optimizer_full = optim.Adam(model.parameters(), lr=2e-4) # lower learning rate for stable fine-tuning
