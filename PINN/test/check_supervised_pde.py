...
# Now compute PDE loss
pde_loss = calc_pde_loss(model, X_f)
print(f"Supervised model BC Loss: {nn.MSELoss()(model(X_u)[0], V_u).item():.6f}")
print(f"Supervised model PDE Loss: {pde_loss.item():.6f}")
